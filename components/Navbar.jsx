...
function Navigation() {
    ...
    return (
        <div>
            <Navbar
                className={`mx-auto max-w-screen-xl px-4 py-2 lg:px-3 lg:py-4 lg:fixed lg:left-1/2 lg:transform lg:-translate-x-1/2 z-20 absolute ${navbarBg} border-none shadow-none backdrop-filter-none transition-all duration-300`}
            >
